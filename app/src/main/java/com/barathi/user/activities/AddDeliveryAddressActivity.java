...
import com.barathi.user.adapters.AreaAdapter;
import com.barathi.user.adapters.CityAdapter;
import com.barathi.user.databinding.ActivityAddDeliveryAddressBinding;
import com.barathi.user.databinding.BottomSheetAddressBinding;
    ...
    private void initListnear() {
        ...
        binding.etAera.setOnClickListener(v -> {
            if(isCitySelected) {
                ...
                Toast.makeText(contextl, "Select City First", Toast.LENGTH_SHORT).show();
            }
        });
...
//ll
    ...
    private void openBottomSheet(List<CityRoot.Datum> cites, List<Area.Datum> aera, int i) {
    ...
    private void addNewAddress() {
        ...
        map.put("latitude", String.valueOf(mylatlang.latitude));
        map.put("longitude", String.valueOf(mylatlang.longitude));
        ...
        if(isUpdet) {
            ...
            Call<RestResponse> call = service.updateAddress(Const.DEV_KEY, token, map);
            ...
            Call<Address> call = service.addAddress(Const.DEV_KEY, token, map);
